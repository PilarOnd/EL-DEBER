        ...
        <div class="col-12">
            <div class="row text-center align-items-stretch g-0" style="padding: 20px; background-color: rgba(245, 245, 245, 0.9);">
                ...
                <div class="col-md-4 d-flex flex-column justify-content-center">
                    ...
                    <p class="mb-0">
                        {{ \Carbon\Carbon::parse($pedidos[0]['fecha_hora_inicio'])->locale('es')->isoFormat('D [de] MMMM YYYY') }}
                        <br> al <br>
                        {{ \Carbon\Carbon::parse($pedidos[0]['fecha_hora_fin'])->locale('es')->isoFormat('D [de] MMMM YYYY') }}
                    </p>
                </div>

                <div class="col-md-4 text-center d-flex flex-column align-items-center">
                    <h5 class="fw-bold cliente-text" style="color: {{ $cliente['color_fuente'] }}">PRESUPUESTO</h5>
                    <h4 class="fw-bold" style="font-size: 19.5px;">{{ number_format($lineaPedido['tarifa']['monto'], 0, '', '.') }} ${{ strtoupper($lineaPedido['tarifa']['moneda']) }}</h4>
        ...
        <div class="col-12">
            <div class="row text-center align-items-stretch g-0" style="padding: 20px; background-color: rgb(233, 229, 229, 0.9);">
                ...
                <div class="col-md-3 d-flex flex-column justify-content-center">
                    ...
                    <p class="mb-0">{{ number_format($lineaPedido['objetivo'], 0, '', '.') }} Impresiones</p>
                </div>
