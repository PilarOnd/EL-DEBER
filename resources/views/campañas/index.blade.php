                                ...
                                <tbody>
                                    @foreach($display as $campania)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('campañas.display', $campania['id']) }}" class="btn btn-sm btn-primary" target="_blank">
                                ...
                                <tbody>
                                    @foreach($branded as $campania)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('campañas.branded', $campania['id']) }}" class="btn btn-sm btn-primary" target="_blank">
                                                    <i class="bi bi-eye"></i> Ver
                                                </a>
                                            </td>
                                        </tr>
                                ...
                                <tbody>
                                    @foreach($redes as $campania)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('campañas.redes', $campania['id']) }}" class="btn btn-sm btn-primary" target="_blank">
                                                    <i class="bi bi-eye"></i> Ver
                                                </a>
                                            </td>
                                        </tr>
